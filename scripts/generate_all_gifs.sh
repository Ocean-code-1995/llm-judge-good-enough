...
python scripts/generate_monte_carlo_gif.py \
    ...
    --output benchmarks/movielens/figures/monte_carlo_robustness.gif \
    --llm-col "GPT-4o-mini" \
...
python scripts/generate_monte_carlo_gif.py \
    ...
    --output benchmarks/wmt-human/figures/monte_carlo_GPT.gif \
...
python scripts/generate_monte_carlo_gif.py \
    --data benchmarks/wmt-human/data/wmt-human_en_de_judged_cleaned.csv \
    --output benchmarks/wmt-human/figures/monte_carlo_LLAMA.gif \
...
python scripts/generate_monte_carlo_gif.py \
    --data benchmarks/wmt-human/data/wmt-human_en_de_judged_cleaned.csv \
    --output benchmarks/wmt-human/figures/monte_carlo_MISTRAL.gif \
...
for METRIC in informativeness relevance fluency coherence; do
    for MODEL in GPT LLAMA MISTRAL; do
        echo ""
        echo "========================================"
        ...
        python scripts/generate_monte_carlo_gif.py \
            ...
            --output "benchmarks/newsroom/figures/monte_carlo_${METRIC}_${MODEL}.gif" \
...
python scripts/generate_monte_carlo_gif.py \
    ...
    --output benchmarks/politifact/figures/monte_carlo_s3.gif \
    --llm-col "GPT-4o mini" \
...
python scripts/generate_monte_carlo_gif.py \
    ...
    --output benchmarks/politifact/figures/monte_carlo_s6.gif \
    --llm-col "GPT-4o mini" \
...
echo ""
echo "WMT-Human (3):"
echo "  - benchmarks/wmt-human/figures/monte_carlo_GPT.gif"
echo "  - benchmarks/wmt-human/figures/monte_carlo_LLAMA.gif"
echo "  - benchmarks/wmt-human/figures/monte_carlo_MISTRAL.gif"
echo ""
echo "Newsroom (12):"
for METRIC in informativeness relevance fluency coherence; do
    for MODEL in GPT LLAMA MISTRAL; do
        echo "  - benchmarks/newsroom/figures/monte_carlo_${METRIC}_${MODEL}.gif"
    done
done
echo ""
echo "PolitiFact (2):"
echo "  - benchmarks/politifact/figures/monte_carlo_s3.gif"
echo "  - benchmarks/politifact/figures/monte_carlo_s6.gif"
